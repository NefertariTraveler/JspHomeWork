...
<head>
    ...
    <script>
        ...
        function checkUserName(userName){
            $.ajax({
                type: "POST",
                url: "${pageContext.request.contextPath}/findPhoneByName.html",
...
<body>
    ...
    <form action="${pageContext.request.contextPath}/${msg=='2' ? 'updatePhone.html' : 'addPhone.html'}" method="post" onsubmit="return checkAll();">
        <input type="hidden" name="id" value="${phone.id}">
        用户名：<input type="text" name="userName" id="userName" value="${phone.userName}" onchange="checkUserName(this.value);"/>
                <span id="userNameErr"></span><br />
        密码：<input type="password" name="pwd" id="pwd" value="${phone.pwd}" />
        ...
        尺寸：<input name="size" id="size" value="${phone.size}" />
        ...
        销量：<input name="sales" id="sales" value="${phone.sales}" />
